...
which(is.na(sp::over(pts,sp::geometry(polys))))->outys
if(!is.null(outys)){
  plot(polys)
  points(pts$Long[outys],pts$Lat[outys],pch=16,col='red')
  text(168.71,-36.98,paste(pts$CouncilSiteID[outys],collapse='\n'))
}
